...
export const api = {
  // Destinations
  getDestinations: () =>
    fetch(`${API_URL}/api/destinations`).then((response) =>
  ...
  // Stream control
  getStreamStatus: () =>
    fetch(`${API_URL}/api/stream/status`).then((response) =>
      parseJson<unknown>(response)
    ),
  startStream: () =>
    fetch(`${API_URL}/api/stream/start`, { method: "POST" }).then((response) =>
      parseJson<unknown>(response)
    ),
  stopStream: () =>
    fetch(`${API_URL}/api/stream/stop`, { method: "POST" }).then((response) =>
      parseJson<unknown>(response)
    ),

  // Analytics
  getAnalyticsLive: () =>
    fetch(`${API_URL}/api/analytics/live`).then((response) =>
      parseJson<unknown>(response)
    ),
  getAnalyticsHistory: () =>
    fetch(`${API_URL}/api/analytics/history`).then((response) =>
      parseJson<ApiStreamHistory[]>(response)
    ),

  // Team
  getTeam: () =>
    fetch(`${API_URL}/api/team`).then((response) =>
